...
public class DirectorDeleteCA extends javax.swing.JFrame {
   ...
   private  PreparedStatement pst;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DirectorDeleteCA.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DirectorDeleteCA().setVisible(true);
            }
        });
    }
