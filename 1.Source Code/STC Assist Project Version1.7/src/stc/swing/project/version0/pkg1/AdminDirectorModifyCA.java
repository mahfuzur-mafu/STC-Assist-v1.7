...
public class AdminDirectorModifyCA extends javax.swing.JFrame {
  ...
  private   String inputFName;
   ...
   private  ResultSet rs;
    ...
    private void initComponents() {
        ...
        phone_numberLayout.setVerticalGroup(
            ...
            .addGroup(phone_numberLayout.createSequentialGroup()
                ...
                .addGap(30, 30, 30)
                .addGroup(phone_numberLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(ca_newform1, javax.swing.GroupLayout.DEFAULT_SIZE, 35, Short.MAX_VALUE)
    ...
    private void ca_newform1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ca_newform1MouseClicked
           AdminDirectorModifyCA directormodifyca  = new AdminDirectorModifyCA();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdminDirectorModifyCA.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdminDirectorModifyCA().setVisible(true);
            }
        });
    }
