...
public class DirectorViewCA extends javax.swing.JFrame {
...
private ResultSet rs;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DirectorViewCA.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DirectorViewCA().setVisible(true);
            }
        });
    }
