...
public class AdminPage extends javax.swing.JFrame {
  ...
  private  ResultSet rs;
    ...
    private void initComponents() {
        ...
        admin_adddirector_btn.setBackground(new java.awt.Color(241, 78, 78));
    ...
    private void dir_submitMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_dir_submitMouseClicked
         ...
         try {
              String sql =" INSERT INTO director_dbms (Id,full_name,institution_name,email,phone_number,passcode,gender,tshirt) VALUES (?,?,?,?,?,?,?,?)";
    ...
    private void responsesMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_responsesMouseClicked
        ...
        Desktop.getDesktop().browse(new URI("https://docs.google.com/forms/d/1jCYXvMwF6tXCyo_NV-KTlF1zfi0OuLmAHeJnH_oCoj4/edit#responses"));
